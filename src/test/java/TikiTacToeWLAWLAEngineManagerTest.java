...
public class TikiTacToeWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TikiTacToeWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TikiTacToeWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TikiTacToeWLAIW/InitOutcome.xml").getDocumentElement();
